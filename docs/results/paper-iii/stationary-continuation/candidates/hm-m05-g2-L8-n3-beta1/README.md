...
![hm-m05-g2-L8-n3-beta1](stationary-continuation.png)
...
| critical mode n₀ | 3 |
| χ\*(β) | 4.108419 |
| closed-form β_{n₀} | +0.25323777 |
| α_{n₀} | 0.58122429 |
| meshes | 48, 96 |
| measured c₂ (N=96) | +0.43490696 |
| theory c₂ = β_{n₀}/α_{n₀} | +0.43569716 |
| relative error (finest) | 1.814e-03 |
| observed order | 1.996 |
...
python stationary_branch_validation.py \
  ...
  --meshes 48,96 \
  --output-dir /tmp/hm-m05-g2-L8-n3-beta1 --check
```
