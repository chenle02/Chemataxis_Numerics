# high_modes/subcritical/a1_b1_alpha1_m0p5_beta1_gamma2_mu1_nu1_L8_n3

> **Historical folder name.** The full center-graph cubic coefficient is
> `beta_n0 = 0.253237772810704`, so this case is **supercritical**, despite the
> directory name. The archived pre-correction value `-1.76010919822446`
