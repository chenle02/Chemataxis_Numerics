# high_modes/subcritical/a1_b1_alpha1_m0p5_beta1_gamma3_mu1_nu1_L5p3_n2

> **Historical folder name.** The full center-graph cubic coefficient is
> `beta_n0 = 1.05763117921668`, so this case is **supercritical**, despite the
> directory name. The archived pre-correction value `-2.52822952308306`
