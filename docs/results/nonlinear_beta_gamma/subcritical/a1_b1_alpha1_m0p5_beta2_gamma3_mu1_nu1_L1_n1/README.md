# nonlinear_beta_gamma/subcritical/a1_b1_alpha1_m0p5_beta2_gamma3_mu1_nu1_L1_n1

> **Historical folder name.** The full center-graph cubic coefficient is
> `beta_n0 = 7.68562374071319`, so this case is **supercritical**, despite the
> directory name. The archived pre-correction value `-15.0258484700784`
